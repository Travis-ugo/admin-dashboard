        ...
        <div className="rounded-2xl p-8">
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 py-2">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-neutral-300">or continue with</span>
                    <div className="h-px bg-neutral-100 flex-1" />
                </div>
                ...
                <button
                    ...
                    className="w-full h-14 flex items-center justify-center gap-3 bg-white border border-neutral-200 rounded-2xl text-neutral-700 font-bold hover:bg-neutral-50 transition-all active:scale-[0.98] disabled:opacity-50"
                >
                    {googleLoading ? (
